        ...
        <div className="login-page">
            <div className="login-container">
                ...
                {onSignup ? <div><form className="login-form" autoComplete="off" onSubmit={userSignup}>
                    <input className="login-form-input" name="fname" type="text" value={firstName} placeholder="First Name" onChange={e => setFirstName(e.target.value)} required/>
                    <input className="login-form-input" name="lname" type="text" value={lastName} placeholder="Last Name" onChange={e => setLastName(e.target.value)} required/>
                    <input className="login-form-input" name="email" type="text" value={email} placeholder="Email" onChange={e => setEmail(e.target.value)} required />
                    <input className="login-form-input" name="password" type="password" value={password} placeholder="Password" onChange={e => setPassword(e.target.value)} required/>
                    <input className="login-form-input" name="password" type="password" value={password} placeholder="Confirm Password" onChange={e => setConfirmPassword(e.target.value)} required/>
